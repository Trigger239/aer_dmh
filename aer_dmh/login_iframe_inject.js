let MODULE_NAME = "aer_dmh/login_iframe_inject.js";

if(window.location !== window.parent.location){
  debug_log("In iframe");

  let script_id = "aer_dmh_login_script";
  ...
  if(!document.getElementById(script_id)){
    ...
    s.onload = function(){
      ...
      window.postMessage({
          type: "aer_dmh_login_iframe_injected",
    ...
    s.src = chrome.runtime.getURL("login_iframe_script.js");
  }
}
else{
